...
#define RIGHT_DEVIATION 20 // Slow down right wheel for ultrasonic to detect wall
...
void loop() {
  if (state == FORWARD) {
    ...
    if (predicted_color == C_WHITE) {
      ...
      turn_stage == FIRST_TURN; // Reset turn stage to do first turn for compound turn
    }
